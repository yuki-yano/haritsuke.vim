...
describe("createDebugLogger", () => {
  ...
  it("time and timeEnd measure duration", async () => {
    const { logSpy, restore } = interceptConsole()
  ...
  it("timer does not log when disabled", () => {
    const { logSpy, restore } = interceptConsole()
  ...
  it("timeEnd without time does nothing", () => {
    const { logSpy, restore } = interceptConsole()
  ...
  it("multiple timers work independently", async () => {
    const { logSpy, restore } = interceptConsole()
